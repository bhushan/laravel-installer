        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ old('app_url') }}"
...
{{ $errors->first('table_prefix') }}
                ...
                <input type="hidden" class="hidden" name="table_prefix" id="table_prefix" value=""
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username"
                           value="{{ old('database_username') }}" placeholder="User Name"/>
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_password" id="database_password"
                           value="{{ old('database_password') }}" placeholder="Database Passwords"/>
...
@endif
                ...
                <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_driver" id="mail_driver" value="{{ old('mail_driver') }}"
                           placeholder="Mail Driver e:g. sendmail"/>
                ...
                <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_host" id="mail_host" value="{{ old('mail_host') }}"
                           placeholder="Mail Host e:g. smtp.gmail.com"/>
                ...
                <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="mail_port" id="mail_port" value="{{ old('mail_port') }}"
                ...
                <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_username" id="mail_username" value="{{ old('mail_username') }}"
                           placeholder="Mail Username / Email Address"/>
                ...
                <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_encryption" id="mail_encryption" value="{{ old('mail_encryption') }}"
                           placeholder="Mail Encryption e:g. tls "/>
...
@endif
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" required name="purchase_code" id="purchase_code"
                           value="{{ old('purchase_code') }}" placeholder="Purchase Code"/>
                ...
                <div class="form-group {{ $errors->has('password_confirm') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="password_confirmation" id="password_confirm"
