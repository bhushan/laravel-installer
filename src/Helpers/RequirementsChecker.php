...
namespace Enlight\LaravelInstaller\Helpers;
...
class RequirementsChecker
{
    ...
    {
        $results = [];
        $extensions_limit_array = ['max_execution_time' => 180, 'upload_max_filesize' => 128, 'post_max_size' => 128];
                    ...
                    foreach ($requirements[$type] as $requirement) {
                        ...
                        if ($requirement === 'proc_open') {
                            $descriptorspec = [
                                ...
                                2 => ['file', public_path('error-output.txt'), 'a'] // stderr is a file to write to
                            ];
